...
export const cateringMenuList: IMenuItem[] = [
  {
    ...
    category: "ALA Carte & by the Pound",
  ...
  },
  {
    ...
    price: 20.00,
    description: "This smoked whole chicken is Juicy, Delicious, and simply can't be beat.",
    category: "ALA Carte & by the Pound",
  ...
  },
  {
    ...
    price: 12.00,
    description: "This smoked 1/2 chicken is Juicy, Delicious, and simply can't be beat.",
    category: "ALA Carte & by the Pound",
  ...
  },
  {
    ...
    price: 7.00,
    description: "Baked Potatoes, sour cream, bacon and chives. (Feeds 2-3 people)",
    category: "ALA Carte & by the Pound",
  ...
  },
  {
    name: "Brisket Chili",
    price: 10.00,
    description: "Homemade Chili with Smoked Brisket Burnt Ends paired with fresh Green Peppers, Onions, Diced Tomatoes, and Pinto Beans. Includes 2 pieces of Jalapeno Chedder Cornbread.",
    category: "ALA Carte & by the Pound",
  ...
  },
  {
    ...
    price: 50.00,
    description: "Includes ribs, pulled pork, brisket, pulled chicken, jalapeno cheddar cornbread and your choice of 2 sides.",
    category: "Family Dinners to Go",
  ...
  },
  {
    ...
    price: 150.00,
    description: "Includes ribs, pulled pork, beef brisket, pulled chicken, jalapeno cheddar cornbread, and your choice of 2 sides.",
    category: "Family Dinners to Go",
