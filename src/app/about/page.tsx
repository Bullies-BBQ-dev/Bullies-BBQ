  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      <Banner
        ...
        title="About Us"
      />
      <section className="text-center max-w-screen-xl mx-4">
        ...
        <div className="grid lg:grid-cols-4 xl:grid-cols-6 gap-4 py-10">
          <div className="flex flex-col items-center col-span-2 lg:col-start-2 xl:col-start-1">
            <img
