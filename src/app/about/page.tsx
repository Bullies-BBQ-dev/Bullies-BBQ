        ...
        <section className="text-center min-w-60 max-w-screen-xl mx-5">
          ...
          <div className="flex flex-col items-center col-span-2 pb-5 sm:pb-10 gap-2">
            <div className="px-5 grid gap-2 sm:gap-4 py-4">
              ...
              <p>
                Want to join the Bullies team? We&apos;re always on the lookout
                for exceptional talent, please click the link below to inquire
                about potential future openings and check back often for
                updates!
              </p>
              <a
                href=" https://j.wrkstrm.us/a3d940aa/bullies-bbq"
                target="_blank"
                className="text-blue-500 hover:text-blue-400 duration-100 ease-in-out"
              >
                {" "}
                https://j.wrkstrm.us/a3d940aa/bullies-bbq
              </a>
            </div>
          </div>
        </section>
      </main>
      <div className="flex flex-col bg-yellow-400  py-10 mb-20">
        <h2 className={`${redRoseFont.className} text-4xl text-center pb-10`}>
